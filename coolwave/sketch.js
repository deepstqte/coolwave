function setup() {
  let canvasScale = 1;
  let canvasSize = 1000 * canvasScale;
  colorMode(HSL);
  ...
  var disorderMapSequence = [64, 128, 256, 512, 1024, 1536];
  var disorderMapFactor = random(disorderMapSequence);

  var inc = scl / (disorderMapFactor * canvasScale);
  var palette = random(["user1723", "mleejr", "kiki", "johnnycash424", "skittles", "codincowboy", "gallwas", "seacasa", "sartocrates", "nikita", "metabananas", "creeezy", "meltedmindz", "garrett", "fivetoads", "massurealist", "jordan"]);
  var xoff = 0;
